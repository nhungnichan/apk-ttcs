...
public class LoginActivity extends AppCompatActivity {
    ...
    void login() {
        ...
        String pw = txtPassword.getText().toString(); // lay ra gia tri trong edittext
        boolean status = chkRemember.isChecked(); //kiem tra trang thai xem co ton tai user hay 0
